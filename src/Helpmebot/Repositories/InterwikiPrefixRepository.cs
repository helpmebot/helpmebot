// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InterwikiPrefixRepository.cs" company="Helpmebot Development Team">
...
namespace Helpmebot.Repositories
{
    ...
    public class InterwikiPrefixRepository : RepositoryBase<InterwikiPrefix>, IInterwikiPrefixRepository
    {
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="InterwikiPrefixRepository"/> class.
        /// </summary>
        /// <param name="session">
        /// The session.
        /// </param>
