...
namespace HelpmebotTestHarness
{
    ...
    /// <summary>
    ///This is a test class for VersionTest and is intended
    ///to contain all VersionTest Unit Tests
    ///</summary>
    [TestClass( )]
    public class VersionTest
    {
        ...
        /// <summary>
        ///A test for getVersionString
        ///</summary>
        [TestMethod( )]
        public void getVersionStringTest( )
        {
            Version target = new Version( );
            Assert.IsFalse( target.getVersionString( ).Contains( "-r0" ) );
            Assert.IsTrue( target.getVersionString( ).Contains( "-r" ) );
        }
        ...
        {
            Version_Accessor target = new Version_Accessor( ); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for Version Constructor
        ///</summary>
        [TestMethod( )]
        public void VersionConstructorTest( )
        {
            Version target = new Version( );
