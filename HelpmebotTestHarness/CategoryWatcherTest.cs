...
namespace HelpmebotTestHarness
{
    ...
    /// <summary>
    ///This is a test class for CategoryWatcherTest and is intended
    ///to contain all CategoryWatcherTest Unit Tests
    ///</summary>
    [TestClass( )]
    public class CategoryWatcherTest
    {
        ...
        {
            CategoryWatcher_Accessor target = new CategoryWatcher_Accessor( ); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for CategoryWatcher Constructor
        ///</summary>
        [TestMethod( )]
        public void CategoryWatcherConstructorTest( )
        {
            CategoryWatcher target = new CategoryWatcher( );
