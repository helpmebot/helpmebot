...
namespace HelpmebotTestHarness
{
    ...
    public class RegistrationTest
    {
        ...
        /// <summary>
        ///A test for getRegistrationDate
        ///</summary>
        [TestMethod( )]
        public void getRegistrationDateTest( )
        {
            Registration target = new Registration( ); // TODO: Initialize to an appropriate value
            string username = string.Empty; // TODO: Initialize to an appropriate value
            DateTime expected = new DateTime( ); // TODO: Initialize to an appropriate value
            DateTime actual;
            actual = target.getRegistrationDate( username );
        ...
        {
            Registration_Accessor target = new Registration_Accessor( ); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for Registration Constructor
        ///</summary>
        [TestMethod( )]
