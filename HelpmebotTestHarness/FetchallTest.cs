...
namespace HelpmebotTestHarness
{
    ...
    /// <summary>
    ///This is a test class for FetchallTest and is intended
    ///to contain all FetchallTest Unit Tests
    ///</summary>
    [TestClass( )]
    public class FetchallTest
    {
        ...
        {
            Fetchall_Accessor target = new Fetchall_Accessor( ); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for Fetchall Constructor
        ///</summary>
        [TestMethod( )]
        public void FetchallConstructorTest( )
        {
            Fetchall target = new Fetchall( );
