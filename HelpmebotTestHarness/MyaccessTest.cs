...
namespace HelpmebotTestHarness
{
    ...
    public class MyaccessTest
    {
        ...
        {
            Myaccess_Accessor target = new Myaccess_Accessor( ); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for Myaccess Constructor
        ///</summary>
        [TestMethod( )]
        public void MyaccessConstructorTest( )
        {
