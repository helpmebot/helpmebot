...
namespace HelpmebotTestHarness
{
    ...
    /// <summary>
    ///This is a test class for BlockInfoTest and is intended
    ///to contain all BlockInfoTest Unit Tests
    ///</summary>
    [TestClass( )]
    public class BlockInfoTest
    {
        ...
        {
            BlockInfo_Accessor target = new BlockInfo_Accessor( ); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for BlockInfo Constructor
        ///</summary>
        [TestMethod( )]
        public void BlockInfoConstructorTest( )
        {
            BlockInfo target = new BlockInfo( );
