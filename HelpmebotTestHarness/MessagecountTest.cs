...
namespace HelpmebotTestHarness
{
    ...
    /// <summary>
    ///This is a test class for MessagecountTest and is intended
    ///to contain all MessagecountTest Unit Tests
    ///</summary>
    [TestClass( )]
    public class MessagecountTest
    {
        ...
        {
            Messagecount_Accessor target = new Messagecount_Accessor( ); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for Messagecount Constructor
        ///</summary>
        [TestMethod( )]
        public void MessagecountConstructorTest( )
        {
            Messagecount target = new Messagecount( );
