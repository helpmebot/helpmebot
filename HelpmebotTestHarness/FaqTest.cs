...
namespace HelpmebotTestHarness
{
    ...
    /// <summary>
    ///This is a test class for FaqTest and is intended
    ///to contain all FaqTest Unit Tests
    ///</summary>
    [TestClass( )]
    public class FaqTest
    {
        ...
        {
            Faq_Accessor target = new Faq_Accessor( ); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for Faq Constructor
        ///</summary>
        [TestMethod( )]
        public void FaqConstructorTest( )
        {
            Faq target = new Faq( );
