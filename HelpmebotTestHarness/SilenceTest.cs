...
namespace HelpmebotTestHarness
{
    ...
    /// <summary>
    ///This is a test class for SilenceTest and is intended
    ///to contain all SilenceTest Unit Tests
    ///</summary>
    [TestClass( )]
    public class SilenceTest
    {
        ...
        {
            Silence_Accessor target = new Silence_Accessor( ); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for Silence Constructor
        ///</summary>
        [TestMethod( )]
        public void SilenceConstructorTest( )
        {
            Silence target = new Silence( );
