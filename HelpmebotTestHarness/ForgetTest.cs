...
namespace HelpmebotTestHarness
{
    ...
    /// <summary>
    ///This is a test class for ForgetTest and is intended
    ///to contain all ForgetTest Unit Tests
    ///</summary>
    [TestClass( )]
    public class ForgetTest
    {
        ...
        {
            Forget_Accessor target = new Forget_Accessor( ); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for Forget Constructor
        ///</summary>
        [TestMethod( )]
        public void ForgetConstructorTest( )
        {
            Forget target = new Forget( );
