...
namespace HelpmebotTestHarness
{
    ...
    /// <summary>
    ///This is a test class for UptimeTest and is intended
    ///to contain all UptimeTest Unit Tests
    ///</summary>
    [TestClass( )]
    public class UptimeTest
    {
        ...
        {
            Uptime_Accessor target = new Uptime_Accessor( ); // TODO: Initialize to an appropriate value
        ...
        /// <summary>
        ///A test for Uptime Constructor
        ///</summary>
        [TestMethod( )]
        public void UptimeConstructorTest( )
        {
            Uptime target = new Uptime( );
